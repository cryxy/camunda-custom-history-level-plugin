...
public class CreateVariablesDelegate implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		execution.setVariable(VAR_FOO, "bar");
		execution.setVariable(VAR_HELLO, "world");
		execution.setVariable(VAR_ACTION, "important");
		execution.setVariable(VAR_CAMUNDA, "rocks");
	}
}
